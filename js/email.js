function validaForm(frm) {
    ...
    */
    ...
    let escolhaSexo = -1; //valor negativo default (padrão) que significa que nada foi escolhido ainda.
    //No bloco de código abaixo foi criado um ciclo entre
    //os radios button com o mesmo nome (sexo)
    for(let x = frm.sexo.length-1; x > -1; x--) {
        /*
        ...
        x = 1, x= 0 e para, pois x não pode ser -1.
        */
    ...
    //o campo telefone não pode estar vazio pelo menos
    if(frm.tel.value == "" || frm.tel.value == null) {
        //É mostrado um alerta, caso o campo esteja vazio.
        alert("Por favor, indique o seu telemóvel.");
        //Foi definido um focus no campo.
        frm.tel.focus();
        //o form não é enviado.
        return false;
    ...
    if(frm.ass.value == "" || frm.ass.value == null) {
